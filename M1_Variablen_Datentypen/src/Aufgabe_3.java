...
public class Aufgabe_3 {
	...
	public static void main(String[] args){
		...
		System.out.println("Geben Sie die Gr?sse der ersten Person ein (m).");
		...
		if (alter1 > alter2){
			System.out.println(name1 + " ist " + (alter1-alter2) + " ?lter als " + name2);
		}
		else{
			System.out.println(name2 + " ist " + (alter2-alter1) + " ?lter als " + name1);
		}
